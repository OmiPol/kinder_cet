...
def generate_launch_description():
    ...
    world = 'Dylans_World.world'
    #world = 'obstacle_avoidance_4.world'
    #world = 'puzzlebot_arena_aruco_goals.world'
    ...
    robot_config_list = [
        {
            ...
            'x': 0.0, 'y': 0.0, 'yaw': 0.0,
            'lidar_frame': 'sim/laser_frame', #cambiar a /sim/laser_frame
            'camera_frame': 'camera_link_optical', #cambiar/sim_camera_link_optical
            'tof_frame': 'tof_link'
        }
    ]
